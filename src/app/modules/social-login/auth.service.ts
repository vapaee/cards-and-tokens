...
export class AuthService {
    ...
    isSignedIn(providerId: string): Promise<SocialUser> {
        let providerObject = this.providers.get(providerId);
        if (providerObject) {
            return providerObject.isSignedIn().then((user: SocialUser) => {
            ...
            return Promise.reject(AuthService.LOGIN_PROVIDER_NOT_FOUND);
        }        
    }
